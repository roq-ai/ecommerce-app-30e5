  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Ecommerce app: Unleashing the Power of Seamless Online Shopping with Integrated Backend Services for an Unmatched User Experience"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Ecommerce app: Unleashing the Power of Seamless Online Shopping with Integrated Backend Services for an Unmatched User Experience`}
            </Text>
            <Box
